    ...
    <main className="min-h-screen flex flex-col">
      ...
      <div className="flex-1 flex flex-col items-center justify-center px-5 py-20">
        <div className="max-w-2xl text-center space-y-6">
          <h1 className="text-4xl font-bold">About Recipe and Me</h1>
          <p className="text-lg text-muted-foreground">
            Recipe and Me is a family recipe preservation platform that helps you capture, digitize, and share 
